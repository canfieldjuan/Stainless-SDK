...
from ._exceptions import APIStatusError, McpServersError
...
class McpServers(SyncAPIClient):
    pet: pet.PetResource
    store: store.StoreResource
    user: user.UserResource
    with_raw_response: McpServersWithRawResponse
    with_streaming_response: McpServersWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous McpServers client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("MCP_SERVERS_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = McpServersWithRawResponse(self)
        self.with_streaming_response = McpServersWithStreamedResponse(self)
...
class AsyncMcpServers(AsyncAPIClient):
    pet: pet.AsyncPetResource
    store: store.AsyncStoreResource
    user: user.AsyncUserResource
    with_raw_response: AsyncMcpServersWithRawResponse
    with_streaming_response: AsyncMcpServersWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncMcpServers client instance.
        ...
        self.with_raw_response = AsyncMcpServersWithRawResponse(self)
        self.with_streaming_response = AsyncMcpServersWithStreamedResponse(self)
...
class McpServersWithRawResponse:
    def __init__(self, client: McpServers) -> None:
...
class AsyncMcpServersWithRawResponse:
    def __init__(self, client: AsyncMcpServers) -> None:
...
class McpServersWithStreamedResponse:
    def __init__(self, client: McpServers) -> None:
...
class AsyncMcpServersWithStreamedResponse:
    def __init__(self, client: AsyncMcpServers) -> None:
