...
from mcp_servers import McpServers, AsyncMcpServers, APIResponseValidationError
from mcp_servers._types import Omit
from mcp_servers._models import BaseModel, FinalRequestOptions
from mcp_servers._exceptions import APIStatusError, APITimeoutError, McpServersError, APIResponseValidationError
from mcp_servers._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: McpServers | AsyncMcpServers) -> int:
...
class TestMcpServers:
    client = McpServers(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "mcp_servers/_legacy_response.py",
                        "mcp_servers/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "mcp_servers/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(McpServersError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = McpServers(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: McpServers) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = McpServers(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(MCP_SERVERS_BASE_URL="http://localhost:5000/from/env"):
            client = McpServers(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: McpServers) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: McpServers) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: McpServers) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = McpServers(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = McpServers(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("mcp_servers._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: McpServers) -> None:
    ...
    @mock.patch("mcp_servers._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: McpServers) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: McpServers, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMcpServers:
    client = AsyncMcpServers(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(McpServersError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = AsyncMcpServers(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMcpServers) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MCP_SERVERS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMcpServers(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMcpServers) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMcpServers) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMcpServers) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMcpServers(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMcpServers(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncMcpServers
    ) -> None:
        respx_mock.get("/store/inventory").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMcpServers, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from mcp_servers._utils import asyncify
        from mcp_servers._base_client import get_platform
